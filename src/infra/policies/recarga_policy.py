...
class RecargaPolicy(ABC):
    ...
    def _encontrar_posto_mais_proximo(self, veiculo, grafo, navegador, ambiente, postos, margem_seguranca: float = 10.0):
        ...
        for posto_nome in postos:
            ...
            tempo_viagem_h = ambiente._calcular_tempo_rota(rota) if hasattr(ambiente, '_calcular_tempo_rota') else distancia / 50.0
