...
class PlanoRecarga:
    ...
    @property
    #TODO: rever porque acho que a rota nao precisa ser maior que 2 por exemplo se estiver no posto, ou isso ja é tratado antes?
    ...
    def __repr__(self) -> str:
        desvio_str = f", desvio={self.desvio_rota_km:.1f}km" if self.desvio_rota_km is not None else ""
