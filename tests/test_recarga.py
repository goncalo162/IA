...
def test_recarga():
    ...
    print(f"Autonomia atual: {veiculo_combustao.autonomia_atual}/{veiculo_combustao.autonomia_maxima} km")
    ...
    print(f"Autonomia atual: {veiculo_eletrico.autonomia_atual}/{veiculo_eletrico.autonomia_maxima} km")
    ...
    for dist in distancias:
        ...
        print(f"  Autonomia: {veiculo_teste.autonomia_atual} km ({veiculo_teste.percentual_autonomia_atual:.1f}%)")
        print(f"  Precisa reabastecer? {veiculo_teste.precisa_reabastecer()}")
